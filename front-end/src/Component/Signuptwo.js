                ...
                <div className="flex flex-col items-center justify-center px-4 py-8 mx-auto md:h-screen lg:py-0">
                    <div className={`${mode ? 'bg-darkMode text-textWhite' : 'bg-lightMode'} w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0`}>
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" action="#">
                                <div>
                                    <label htmlFor="Email" className={`${mode ? "text-textWhite" : ""} block mb-2 text-sm font-medium`}>
                                        Email:
                                    </label>
                                    <input
                                        type="email"
                                ...
                                <div>
                                    <label htmlFor="Phone" className={`${mode ? "text-textWhite" : ""} block mb-2 text-sm font-medium`}>
                                        Phone Number:
                                    </label>
                                    <input
                                        type="number"
                                ...
                                <div>
                                    <label htmlFor="Password" className={`${mode ? "text-textWhite" : ""} block mb-2 text-sm font-medium`}>
                                        Password:
                                    </label>
                                    <input
                                        type="password"
                                ...
                                <div>
                                    <label htmlFor="confirmPassword" className={`${mode ? "text-textWhite" : ""} block mb-2 text-sm font-medium`}>
                                        Confirm Password:
                                    </label>
                                    <input
                                        type="password"
                                ...
                                <div className="flex flex-col md:flex-row justify-between">
                                    <Link onClick={moveToStepThree} state={register}>
                                        <button
                                            type="button"
                                            className=" py-3 px-6 text-sm tracking-wider font-semibold rounded-md text-white bg-[#7C9ED9] hover:bg-blue-600 focus:outline-none md:mr-2 mb-2 md:mb-0"
                                        >
                                            Next <ArrowForwardIcon />
                                        </button>
                                    </Link>
